...
-----|------------|--------------------------------------------------|-------------------------------------------|--------
2    | DDP 2      | Dasar-Dasar Pemrograman 2                        | Programming Foundations 2                 | 4
     ...
     | MPKT       | Matakuliah Pengembangan Kepribadian Terintegrasi | -                                         | 5
-----|------------|--------------------------------------------------|-------------------------------------------|--------
3    | SDA        | Struktur Data dan Algoritma                      | Data Structures and Algorithms            | 4
     | MPPI       | Metode Penelitian dan Penulisan Ilmiah           | Scientific Writing & Research Methodology | 3
     | PBP        | Pemrograman Berbasis Platform                    | Platform-based Development                | 4
     | ALIN       | Aljabar Linier                                   | Linear Algebra                            | 3
     | OS         | Sistem Operasi                                   | Operating Systems                         | 4
-----|------------|--------------------------------------------------|-------------------------------------------|--------
4    | TBA        | Teori Bahasa dan Automata                        | Language Theory and Automata              | 4
     | DAA        | Desain dan Analisis Algoritma                    | Algorithms Design and Analysis            | 4
     | BASDAT     | Basis Data                                       | Databases                                 | 4
     | ADPRO      | Pemrograman Lanjut                               | Advanced Programming                      | 4
